...
NS_LOG_COMPONENT_DEFINE("IoDAttackEavesdrop");
...
int main(int argc, char *argv[])
{
    ...
    // MAC attaquant adhoc sur le meme canal physique
    ...
    // Connecter le callback MonitorSnifferRx sur le PHY de l attaquant
    ...
    NS_LOG_UNCOND("\n========== SIMULATION ATTAQUE EAVESDROPPING ==========");
    NS_LOG_UNCOND("Drones legitimes       : " << nDrones);
    NS_LOG_UNCOND("Duree simulation       : " << simTime << "s");
    NS_LOG_UNCOND("Position attaquant     : centre de la zone (50, 50)");
    NS_LOG_UNCOND("");
    ...
    NS_LOG_UNCOND("Paquets dechiffrables  : 0 (ChaCha20-Poly1305 AEAD)");
    NS_LOG_UNCOND("Cle session K_DE       : NON accessible");
    NS_LOG_UNCOND("Identites drones       : NON deductibles");
    NS_LOG_UNCOND("Resultat               : ATTAQUE BLOQUEE");
    NS_LOG_UNCOND("Impact sur le reseau   : 0% (ecoute passive)");
    NS_LOG_UNCOND("======================================================");
