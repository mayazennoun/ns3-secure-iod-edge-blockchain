...
int main(int argc, char *argv[])
{
    ...
    double bcDelay      = 0.1; // 100ms blockchain modélisé
    ...
    // Limiter la queue Wi-Fi de l'Edge a 100 paquets (DropTail — document de reference)
    ...
    // Trafic video legitime avec bcDelay (blockchain modelise)
    uint16_t port = 9;
    ...
    NS_LOG_UNCOND("Filtrage Edge            : DropTail 100 paquets (document de reference)");
    NS_LOG_UNCOND("");
