...
NS_LOG_COMPONENT_DEFINE("IoDSim20");
...
int main(int argc, char *argv[])
{
    ...
    monitor->SerializeToXmlFile("iod-results-20.xml", true, true);
    ...
    NS_LOG_UNCOND("\n========== RÉSULTATS SIMULATION IoD - 20 DRONES ==========");
